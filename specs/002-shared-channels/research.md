...
- Recipients keep their channel even if the share is later revoked — the registry stops resolving for *new* visitors, but existing local copies persist (matches FR-009 and Edge Cases).
